...
import (
	...
	"github.com/devRobotAR/crypto/api" // this would be your generated smart contract bindings
	// "devRobotAR/crypto/test_2/api"
...
func main() {
	...
	if err != nil {
		fmt.Println("Error Deploying Smart Casda")
		panic(err)
	}
